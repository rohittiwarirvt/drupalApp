 ...
 *
 */
$drupal_hash_salt = 'IZHCurEMrRiCUwv69oyScMlyHKU61wXA8TR2qqT4gK8';
...
$current_env = getenv('CONTAINER_ENV');

if ($current_env) {
  $env_settings_file = __DIR__ . DIRECTORY_SEPARATOR . 'settings-' . $current_env . '.php';
